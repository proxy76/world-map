const translations = {
  ro: {
    ...
    createNewPostHeader: "✏️ Creează o postare nouă",
    createNewPostHeaderSimple: "Creează o postare nouă",
    createNewPost: "Creează o postare nouă",
    titleLabel: "Titlu *",
    titlePlaceholder: "Un titlu captivant pentru postarea ta...",
    postTypeLabel: "Tip postare *",
    travelTypeLabel: "Tip călătorie *",
    themeLabel: "Tematică *",
    contentLabel: "Conținut *",
    contentPlaceholder: "Povestește-ne despre experiența ta de călătorie...",
    countriesVisitedLabel: "Țări vizitate *",
    searchSelectCountry: "Caută și selectează o țară...",
    addCountry: "Adaugă țară",
    addTag: "Adaugă tag",
    tagsLabel: "Tag-uri (opțional)",
    tagPlaceholder: "Adaugă un tag...",
    addTagButton: "Adaugă",
    imagesLabel: "Imagini (opțional)",
    privacyLabel: "Postare privată",
    privacyDesc: "Vizibilă doar pentru tine și în jurnalul de călătorie",
    cancelButton: "Anulează",
    submitButton: "Publică postarea",
    publishing: "Se publică...",
    publicPost: "Postare publică",
    publicPostDesc: "Vizibilă pentru toți utilizatorii în feed-ul social",
    countriesTagPrefix: "🏴 ",
    tagPrefix: "#",
    imagePreviewAlt: "Previzualizare",
    removeImage: "Șterge",
    requiredFieldsAlert: "Titlul și conținutul sunt obligatorii!",
    postCreationError: "Eroare la crearea postării!",
    visitedCountriesTag: "Țări vizitate",
  ...
  en: {
    ...
    createNewPostHeader: "✏️ Create a new post",
    createNewPostHeaderSimple: "Create a new post",
    createNewPost: "Create New Post",
    titleLabel: "Title *",
    titlePlaceholder: "An engaging title for your post...",
    postTypeLabel: "Post Type *",
    travelTypeLabel: "Travel Type *",
    themeLabel: "Theme *",
    contentLabel: "Content *",
    contentPlaceholder: "Tell us about your travel experience...",
    countriesVisitedLabel: "Countries Visited *",
    ...
    privacyLabel: "Private Post",
    privacyDesc: "Visible only to you and in your travel journal",
    cancelButton: "Cancel",
    ...
    removeImage: "Remove",
    requiredFieldsAlert: "Title and content are required!",
    postCreationError: "Error creating post!",
    visitedCountriesTag: "Countries Visited",
